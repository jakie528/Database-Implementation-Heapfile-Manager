 ...
 * @param rid  record with rid parameter
 * @param rec a record (rec) of the page
 * @return Returns the length and a pointer to the record with RID rid.
 */
 ...
 * @param outRid the RID of the next record that satisfies the scan predicate.
 * @return Returns (via the outRid parameter) the RID of the next record that satisfies the scan predicate.
 */
